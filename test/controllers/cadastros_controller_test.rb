...
class CadastrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cadastro" do
    assert_difference('Cadastro.count') do
      post cadastros_url, params: { cadastro: { board: @cadastro.board, brand: @cadastro.brand, color: @cadastro.color, model: @cadastro.model, note: @cadastro.note, rental_value: @cadastro.rental_value } }
    end
  ...
  test "should update cadastro" do
    patch cadastro_url(@cadastro), params: { cadastro: { board: @cadastro.board, brand: @cadastro.brand, color: @cadastro.color, model: @cadastro.model, note: @cadastro.note, rental_value: @cadastro.rental_value } }
